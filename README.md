...
This repo contains my code and trained weights for a Reinforcement Learning agent that learns aiming mechanics in Counter-Strike using visual input and PPO.
