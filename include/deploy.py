     ...
     while True:
          ...
          if detectionIsValid == 0:
               ...
               if ok:
                    ...
                    needsTracker = True if iou < 0.8 else False
               else:
                    needsTracker = False
               ...
               if needsTracker:
                    ...
                    detectionDx = bb1[0] + vx * (tracking_end - screenshot2 + 0.08) # Prevê o novo X levando em conta a velocidade; + 0.08 pq leva 0.08 segundos para fazer inferencia no modelo de RL
